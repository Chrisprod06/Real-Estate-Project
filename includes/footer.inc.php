          ...
          <div class="widget-a">
            ...
            <div class="w-footer-a">
              <ul class="list-unstyled">
                <li class="color-a">
                  <span class="color-text-a">Phone .</span> +357 99436309, +357 99252247, +30 6943059942 </li>
                <li class="color-a">
                  <span class="color-text-a">Email .</span> apm.smarthouses@gmail.com</li>
                  <li class="color-a">
                    <span class="color-text-a"></span>Download our app<a href="#"> here!</a></li>
              </ul>
            </div>
          </div>
        </div>
