...
<head>
  <meta charset="utf-8">
  <title>About | APM Smart Houses</title>
        ...
        <div class="col-md-4">
          <div class="card-box-d">
            <div class="card-img-d">
              <img src="img/agentBlank.jpg" alt="" class="img-d img-fluid">
            </div>
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
                  <h3 class="title-d">
                    <a href="#" class="link-two">Andreas Christodoulides
                    </a>
                  </h3>
                </div>
              </div>
              <div class="card-body-d">
                ...
                <div class="info-agents color-a">
                  <p>
                    <strong>Phone: </strong> +357 99252247</p>
                  <p>
                    <strong>Email: </strong> chandreas7@cytanet.com.cy</p>
                </div>
              </div>
