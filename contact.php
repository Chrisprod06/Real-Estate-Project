...
<head>
  <meta charset="utf-8">
  <title>Contact | APM Smart Houses</title>
            ...
            <div class="col-md-7">
              <form class="form-a contactForm" action="" method="post" role="form">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    <div class="form-group">
                      <input type="url" name="phone" class="form-control form-control-lg form-control-a"
                        placeholder="Phone" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject">
                      <div class="validation"></div>
                    </div>
                  </div>
